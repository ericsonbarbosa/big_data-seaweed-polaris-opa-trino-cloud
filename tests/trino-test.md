...
Login: admin
http://157.230.202.248:8443

## Teste 2 - Descobrir a porta de instalação e qual a versão do Trino

```bash
# Decobrir a porta que o Trino está utilizando no servidor
sudo ss -tulnp | grep -i trino

# Descobrir a versão, uptime e outras coisas
curl -k https://127.0.0.1:8443/v1/info | jq
```
